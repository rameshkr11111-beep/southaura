...
export const products: Product[] = [
  ...
  },
  {
    ...
    category: "ayurvedic-products",
    description: "A saffron-led Ayurvedic facial ritual for soft, luminous skin.",
    longDescription:
      "Prepared in small batches with saffron, manjistha, sandalwood and nourishing botanical oils. Apply a few drops at night as a traditional facial massage ritual for supple, radiant-looking skin.",
    price: 1190,
    originalPrice: 1390,
    rating: 4.8,
    reviewCount: 186,
    ...
    tags: ["ayurveda", "skincare", "saffron"],
    featured: true,
    newArrival: true
  },
  {
    id: 18,
    name: "Bhringraj Hair Elixir",
    slug: "bhringraj-hair-elixir",
    category: "ayurvedic-products",
    description: "A cooling herbal scalp oil rooted in a Kerala family recipe.",
    longDescription:
      "Bhringraj, amla, hibiscus and curry leaves are slow-infused in coconut and sesame oils. Massage into the scalp before washing for a deeply nourishing weekly hair ritual.",
    price: 725,
    originalPrice: 825,
    rating: 4.7,
    reviewCount: 154,
    image: img("photo-1611930022073-b7a4ba5fcccd"),
    badge: "Wellness favourite",
    stock: 45,
    weight: "200 ml",
    origin: "Kozhikode, Kerala",
    tags: ["ayurveda", "hair care", "bhringraj"],
    featured: true
  },
  {
    id: 19,
    name: "Ashwagandha Wellness Blend",
    slug: "ashwagandha-wellness-blend",
    category: "ayurvedic-products",
    description: "A warming herbal blend for a calm evening milk ritual.",
    longDescription:
      "A balanced mix of ashwagandha, cardamom, nutmeg and turmeric made for warm milk or plant-based alternatives. Crafted in limited batches without artificial flavours or preservatives.",
    price: 495,
    rating: 4.6,
    reviewCount: 112,
    image: img("photo-1596040033229-a9821ebd058d"),
    ...
    weight: "150 g",
    origin: "Mysuru, Karnataka",
    tags: ["ayurveda", "ashwagandha", "wellness"]
  },
  {
    id: 7,
